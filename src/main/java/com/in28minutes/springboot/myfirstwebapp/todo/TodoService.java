...
public class TodoService {
    ...
    static {
        todos.add(new Todo(++todosCount, "alvin", "Learn AWS", LocalDate.now().plusYears(1), false));
        todos.add(new Todo(++todosCount, "alvin", "Learn DevOps", LocalDate.now().plusYears(2), false));
